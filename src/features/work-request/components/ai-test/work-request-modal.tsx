  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <Button
          variant="outline"
          className="bg-gradient-to-r from-purple-500 to-pink-500 text-white border-none text-sm"
        >
          View Work Request
        </Button>
      </DialogTrigger>
                      ...
                      <CardContent className="space-y-2">
                        {workRequest.workStartedAt && (
                          <TimelineItem
                            icon={Activity}
                            label="Work Started"
                            value={format(workRequest.workStartedAt, 'PPpp')}
                          />
                        )}
